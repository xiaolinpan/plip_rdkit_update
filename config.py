...
HBOND_DON_ANGLE_MIN = 120  # Min. angle at the hydrogen bond donor (Hubbard & Haider, 2001) + 10
...
#add the residue information for hydrogen donor or acceptor classification.
