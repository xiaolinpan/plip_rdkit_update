...
class GetPocket:
    ...
    def process_pro_and_lig(self):
        ...
        pro_cut, pros_near_lig = self.select_cut_residue(protein_biop, self.ligand_mol, cut=6.0)
...
ligand_file = "/home/pxl/localhome2/Study/drug_design/test/data/1a3b/1a3b_lig.sdf"
protein_file = "/home/pxl/localhome2/Study/drug_design/test/data/1a3b/protein.pdb"
pdb_id = "1a3b"
